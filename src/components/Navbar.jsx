            ...
            <div className="hidden md:flex items-center space-x-1 lg:space-x-2">
              {user.is_staff ? (
                ...
                <>
                  ...
                  <a href="http://localhost:8000/admin" target="_blank" rel="noopener noreferrer" className="px-3 py-2 rounded-lg text-gray-700 hover:bg-orange-50 hover:text-orange-600 transition text-sm lg:text-base font-medium">
                    ⚙️ Admin Panel
                  </a>
              ...
              <div className="flex flex-col space-y-2">
                ...
                {user.is_staff ? (
                  ...
                  <>
                    ...
                    <a href="http://localhost:8000/admin" target="_blank" rel="noopener noreferrer" className="px-4 py-3 rounded-lg text-gray-700 hover:bg-orange-50 font-medium transition">
