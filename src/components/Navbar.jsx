      ...
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          ...
          <Link to="/" className="flex items-center space-x-2 group">
            <img src={logo} alt="Corn Flour" className="w-9 h-9 rounded-lg object-cover shadow-sm" />
            ...
            <div className="hidden md:flex items-center space-x-1 lg:space-x-2">
              {user.is_staff ? (
                ...
                <>
                  ...
                  <Link to="/contact" className="px-3 py-2 rounded-lg text-gray-700 hover:bg-orange-50 hover:text-orange-600 transition text-sm lg:text-base font-medium">
                    📩 Contact Us
                  </Link>
                  <div className="h-6 w-px bg-gray-300 mx-2"></div>
                  <div className="flex items-center space-x-2 px-3 py-2 bg-orange-50 rounded-lg">
              ...
              <div className="flex flex-col space-y-2">
                ...
                {user.is_staff ? (
                  ...
                  <>
                    ...
                    <Link to="/contact" onClick={() => setIsOpen(false)} className="px-4 py-3 rounded-lg text-gray-700 hover:bg-orange-50 font-medium transition">
                      📩 Contact Us
                    </Link>
                  </>
                )}
